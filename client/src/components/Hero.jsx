...
const Hero = () => {
  ...
  return (
    ...
    <div className='text-center mb-6'>
        ...
        <span className='text-primary'> AI tools
            </span></h1>
        <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto max-sm:text-xs text-gray-600'>
            Transform your content creation with our suite of permission AI tools.
            Write articles, genearte images, and enhance your workflow.
        </p>
    </div>
